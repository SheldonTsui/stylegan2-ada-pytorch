...
def setup_training_loop_kwargs(
    ...
    args.training_set_kwargs = dnnlib.EasyDict(class_name='training.dataset_3D_zip.DispFolderDataset', path=data, use_labels=True, resolution=256, max_size=None, xflip=False)
    args.data_loader_kwargs = dnnlib.EasyDict(pin_memory=True, num_workers=30, prefetch_factor=8)
    #pdb.set_trace()
    try:
